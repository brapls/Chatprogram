...
public class ChatServer {
    ...
    public void createserver() throws Exception {
        ServerSocket server = new ServerSocket(8048, 10);
    ...
    public void sendtoall(String user, String message) {
        ...
        for (Manageuser c : clients) {
                c.sendMessage(user, message, !c.getchatusers().equals(user));
        }
    }
    ...
    class Manageuser extends Thread {
        ...
        public void sendMessage(String chatuser, String chatmsg, Boolean isSender) {
            if(isSender)
            	output.println(chatuser + ": " + chatmsg);
            else
            	output.println("You: " + chatmsg);	
        }
