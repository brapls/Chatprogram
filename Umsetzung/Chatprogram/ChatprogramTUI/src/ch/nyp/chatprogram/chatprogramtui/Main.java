	...
	public static void main(String[] args) {
		...
		while (!menuChoice.equals("3")) {
			...
			if(menuChoice.equals("6")) {
				...
				userSession.SetLastPing(LocalDateTime.now());
				UserApplication u = new UserApplication();
				u.SetUserId(1);
				userSession.SetUser(u);
				userSession.SetSessionIP("1234IP12");
				userSession.SetToken("token");
				//UserSession.CreateNewSession(userSession);
			}
